...
donationDates,cumDonations = getCumulativeDonations(dfDonationsLT50)
ax.plot(donationDates,cumDonations,label="Cumulative Donations From Individuals in Amounts Under $50",color='b',linewidth=3)
donationDates,cumDonations = getCumulativeDonations(dfDonationsRet)
ax.plot(donationDates,cumDonations,label="Cumulative Donations From Retirees",color='g',linewidth=3)
donationDates,cumDonations = getCumulativeDonations(dfDonationsSE)
ax.plot(donationDates,cumDonations,label="Cumulative Donations From Self Employed Individuals",color='c',linewidth=3)
