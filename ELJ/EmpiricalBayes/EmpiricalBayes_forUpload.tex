...
\maketitle
Keywords: Redistricting, gerrymander, Whitford v. Gil, 
\clearpage
\setcounter{page}{1}
...
And the fact that it has a significantly higher efficiency gap than any of these computer-generated maps -- 10\% of which favor Democrats -- supports the opposite conclusion: \emph{Act 43} districts are more "bizarrely shaped" than district plans with a And the fact that it has a significantly higher efficiency gap than any of these computer-generated maps -- 10\% of which favor Democrats -- supports the exact opposite conclusion: \emph{Act 43} districts are, in fact, more "bizarrely shaped" than district plans with a \emph{lower} efficiency gap.
