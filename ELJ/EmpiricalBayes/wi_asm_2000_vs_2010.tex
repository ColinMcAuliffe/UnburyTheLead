...
\CM{I might soften this claim up a bit. There is going to be some effect of voter preferences for individual candidates although it maybe small since partisan voting is very high}
...
\begin{figure}[htb!]
    \begin{center}
        ...
        \caption{Specific asymmetry likelihoods, Top: 2000 cycle districts, Bottom: 2010 cycle districts\CM{This figure appears faded can you make the colors sharper?}}\label{fig:LikelihoodsAsymmetry}
    \end{center}
\end{figure}
