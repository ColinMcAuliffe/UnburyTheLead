...
\KB{once we have the graphics we can start writting this up}
...
\KB{i need to change these sections to talk about both 2000 and 2010 and how they compare, instead of just 2010}
...
\KB{end of sections i need to modify}
