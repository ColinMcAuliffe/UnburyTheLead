...
To calculate future election result likelihoods, we construct an Empirical Bayesian probability model from the district-level vote counts. 
This takes into account ALL possible changes in voter sentiment in proportion to their likelihoods as calculated from the empirical bayesian probability model that is fitted to actual election data at district resolution, for the 6 most recent elections.
