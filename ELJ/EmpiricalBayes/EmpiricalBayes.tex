...
A more recent study of the Act 43 map by Chen \cite{Chen_2017_} found that out of 200 computer-generated maps
 -- which made no effort to minimize partisan bias -- \emph{all of them} had significantly less partisan bias \emph{and} were less "bizarrely shaped" than the Act 43 districts.  Roughly 1/4 of them resulted in an efficiency gap of less than 1\%.
The study concluded:
