...
The RNC and NRCC brief, however, directly argues that doing so would result in "bizarrely shaped districts", though they provide no evidence to support this claim, and indeed, this claim is directly contradicted by maps supplied to the court in plaintiffs' original filing.

A more recent study of the Act 43 map by Chen \cite{Chen_2017_} found that out of 200 computer-generated maps
 -- which made no effort to minimize partisan bias -- 
 \emph{all of them} were significantly \emph{less} "bizarrely shaped" than the Act 43 districts \emph{and} had significantly less partisan bias.
Indeed, 10\% of them resulted in an efficiency gap favoring \emph{Democrats}.
The study concluded:
...
And the fact that it has a significantly higher efficiency gap than any of these computer-generated maps -- 10\% of which favor Democrats -- supports the exact opposite conclusion: \emph{Act 43} districts are, in fact, more "bizarrely shaped" than district plans with a lower efficiency gap.

Whether this demonstrates that supporters of defendants provided false information to the court is beyond the scope of this paper.
Instead, we seek only to analyze this claim with a different technique.
