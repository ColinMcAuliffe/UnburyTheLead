...
Chen and coworkers say in one of their papers \emph{cited in the Amicus Brief} that an additional partisan bias of roughly 4\% of the total available seats in Wisconsin districts is \emph{not} explainable by political geography.
...
A more recent study of the Act 43 map by Chen \cite{Chen_2017_} found that out of 200 computer-generated maps
 -- which made no effort to minimize partisan bias -- \emph{all of them} had significantly less partisan bias \emph{and} were less "bizarrely shaped" than the Act 43 districts.  23% of them resulted in an efficiency gap of less than 1\%.
The study concluded:
...
And the fact that it has a significantly higher efficiency gap than any of the computer-generated maps supports the exact opposite conclusion.
