...
Since some have alleged that the bias in the Wisconsin map is merely the product of changes in voter sentiment and/or political geography \CM{do you have a citation for these statements?}, we have analyzed the asymmetry using
...
In 2000 districts, Madison is surrounded by a several competitive Democratic-leaning districts.
