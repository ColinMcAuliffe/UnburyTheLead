...
\KB{It's this:}
\begin{equation}
    \bar{v'} = \frac{1}{N}\left[N\bar{v}+\hat{v}\right]
\end{equation}

\KB{Which expands and simplifies to:}
\begin{equation}
...
\KB{I noticed you changed this from average standard deviation to average variance, and that it changes the result slightly. (0.00529 instead of 0.0037)  not sure which way is better...}
