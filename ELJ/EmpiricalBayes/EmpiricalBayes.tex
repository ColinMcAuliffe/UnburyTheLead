...
The RNC and NRCC brief cited the studies of Chen and coworkers in support of the notion that gerrymandering can occur unintentionally due to population clustering \cite{Chen_2015_10.1089/elj.2015.0317,Chen_2016_10.1016/j.electstud.2016.06.014} among others.
Chen and coworkers say in that very paper that an additional partisan bias of roughly 4\% of the total available in Wisconsin districts is \emph{not} explainable by political geography.
