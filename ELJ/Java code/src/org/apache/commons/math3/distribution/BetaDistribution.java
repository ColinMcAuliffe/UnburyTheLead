...
public class BetaDistribution extends AbstractRealDistribution {
	...
	public BetaDistribution(double[] xs) {
		...
		//System.out.println("xs length"+xs.length);
	...
	public BetaDistribution(double[] xs, double var_shrinkage) {
		super(new Well19937c());
		//System.out.println("xs length"+xs.length);
		double[] ps = mom_estimate(xs,var_shrinkage);
		alpha = ps[0];
		beta = ps[1];
		z = Double.NaN;
		//System.out.println("ab:"+alpha+" "+beta);
    ...
    public double[] mom_estimate(double[] xs) {
        ...
        //System.out.println("mv: "+mean+" "+var);
    ...
    public double[] mom_estimate(double[] xs, double var_shrinkage) {
        double mean = sample_mean(xs);
        double var = sample_variance(xs);
        
        var = (var_shrinkage + var*(double)xs.length) / (1.0+(double)xs.length);
